...
#include <math.h>
//**************控制端口定义********************
#define DataPort PTH     //数据口使用DataPort

#define   RS  PORTE_PE7
#define   RW  PORTE_PE6
#define   nRD PORTE_PE5
#define   CS  PORTE_PE4
#define   RES PORTE_PE3
...
void Put_fangbo(unsigned int z,unsigned int color)
{
  ...
  //q=(z*120);
  //w=((z*120)+120);
	Put_Line(0,60,z*12,60,color);
	Put_Line(z*12,60,z*12,180,color);
	Put_Line(z*12,180,120,180,color);
	Put_Line(120,180,120,60,color);
	Put_Line(120,60,(z*12)+120,60,color);
	Put_Line((z*12)+120,60,(z*12)+120,180,color);
	Put_Line((z*12)+120,180,240,180,color);
}
...
/********************图片****************************/
#include "picture.h"
void Put_picture1(unsigned int x,unsigned int y,unsigned int fColor,unsigned int bColor)//黑白照片
{
  unsigned int i,j,k;
  LCD_SetPos(x,x+80-1,y,y+60-1);//320x240
	for(i=0;i<=60;i++)
	{
	 for(j=0;j<(80/8);j++)
		{
	   unsigned char m=gImage1[i*10+j];
...
void Put_picture2(unsigned int x,unsigned int y,unsigned int fColor,unsigned int bColor)//黑白照片
{
  unsigned int i,j,k;
  LCD_SetPos(x,x+80-1,y,y+60-1);//320x240
	for(i=0;i<=60;i++)
	{
	 for(j=0;j<(80/8);j++)
		{
	   unsigned char m=gImage2[i*10+j];
...
void Put_picture3(unsigned int x,unsigned int y,unsigned int fColor,unsigned int bColor)//黑白照片
{
  unsigned int i,j,k;
  LCD_SetPos(x,x+80-1,y,y+60-1);//320x240
	for(i=0;i<=60;i++)
	{
	 for(j=0;j<(80/8);j++)
		{
	   unsigned char m=gImage3[i*10+j];
...
void Put_picture4(unsigned int x,unsigned int y,unsigned int fColor,unsigned int bColor)//黑白照片
{
  unsigned int i,j,k;
  LCD_SetPos(x,x+80-1,y,y+60-1);//320x240
	for(i=0;i<=60;i++)
	{
	 for(j=0;j<(80/8);j++)
		{
	   unsigned char m=gImage4[i*10+j];
...
void Put_picture5(unsigned int x,unsigned int y,unsigned int fColor,unsigned int bColor)//黑白照片
{
  unsigned int i,j,k;
  LCD_SetPos(x,x+80-1,y,y+60-1);//320x240
	for(i=0;i<=60;i++)
	{
	 for(j=0;j<(80/8);j++)
		{
	   unsigned char m=gImage5[i*10+j];
...
void Put_picture6(unsigned int x,unsigned int y,unsigned int fColor,unsigned int bColor)//黑白照片
{
  unsigned int i,j,k;
  LCD_SetPos(x,x+80-1,y,y+60-1);//320x240
	for(i=0;i<=60;i++)
	{
	 for(j=0;j<(80/8);j++)
		{
	   unsigned char m=gImage6[i*10+j];
...
void Put_picture7(unsigned int x,unsigned int y,unsigned int fColor,unsigned int bColor)//黑白照片
{
  unsigned int i,j,k;
  LCD_SetPos(x,x+80-1,y,y+60-1);//320x240
	for(i=0;i<=60;i++)
	{
	 for(j=0;j<(80/8);j++)
		{
	   unsigned char m=gImage7[i*10+j];
...
void Put_picture8(unsigned int x,unsigned int y,unsigned int fColor,unsigned int bColor)//黑白照片
{
  unsigned int i,j,k;
  LCD_SetPos(x,x+80-1,y,y+60-1);//320x240
	for(i=0;i<=60;i++)
	{
	 for(j=0;j<(80/8);j++)
		{
	   unsigned char m=gImage8[i*10+j];
