...
{  
  ...
  //{ 
	...
	str[5]=(unsigned int)temp%10000/1000+0x30;
	str[6]=(unsigned int)temp%1000/100+0x30;
	str[7]=(unsigned int)temp%100/10+0x30;
	str[8]=(unsigned int)temp%10+0x30;
